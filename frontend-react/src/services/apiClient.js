...
export const api = {
  ...
  nodeTrain: (episodes) =>
    requestJson(`${NODE_BASE}/api/train`, { method: "POST", body: JSON.stringify({ episodes }) }),
  ...
  pyTrain: (episodes) =>
    requestJson(`${PYTHON_BASE}/train`, { method: "POST", body: JSON.stringify({ episodes }) }),
  pyReset: () => requestJson(`${PYTHON_BASE}/reset`, { method: "POST", body: JSON.stringify({}) })
};
